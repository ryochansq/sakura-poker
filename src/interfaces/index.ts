...
export type Home = '茨城県' | '福島県' | '埼玉県' | '広島県' | '東京都' | '新潟県' | '愛知県' | '神奈川県' | '長野県' | '鹿児島県' | '和歌山県' | '千葉県' | '大阪府' | '熊本県' | '長崎県' | '大分県' | '佐賀県'
export type Uniform = 'ネイビーの制服2010' | 'ベージュの制服' | 'グレーの制服' | 'ネイビーの制服2019' | ''
export type Other = 'KYG' | '2012年度生徒会' | '2016年度生徒会' | '2017年度生徒会' | '2018年度生徒会' | '佐藤' | '森' | '森ハヤシ' | '愛'
